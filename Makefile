...
BREW_OPUS := $(shell brew --prefix opusfile)
...
CFLAGS += -m$(MARCH) -I include -I $(BREW_LIBJPEG)/include \
	...
	-I $(BREW_LIBUV)/include -I $(BREW_OPUS)/include \
...
fmt: ${FMT} libhl
	${CC} ${CFLAGS} -I include/mikktspace -I include/minimp3 -shared -o fmt.hdll ${FMT} ${LIBFLAGS} -L. -lhl ${LIBPNG} $(LIBTURBOJPEG) -lz -lvorbisfile $(LIBOPUS)
